...
public interface PersonExternalService {
    ...
    /**
     * Busca, por identificación, entre las personas cuyo id esté en {@code ids}, aquellas cuyo
     ...
     */
    Page<PersonSummary> findByIdsAndNameOrIdentificationContaining(Collection<UUID> ids, String term, Pageable pageable);
}
