...
/**
 * Reemplazo completo de los datos de un paciente, incluido el documento. Solo lo
 * usa el personal autorizado; el paciente edita sus datos con
 * {@link UpdateOwnPatientRequest}, que no incluye el documento.
 */
...
public class UpdatePatientRequest {
    ...
    public UpdatePatientCommand toCommand() {
        return new UpdatePatientCommand(
                identificationType, identification, firstName, lastName,
                phone, email, sex, birthDate, guardianPhone
        );
    }
}
